...
const LookingForDriver = ({
    ...
    useEffect(() => {
    //   console.log("Selected Vehicle in LookingForDriver:", selectedVehicle);
    }, [selectedVehicle]);
    ...
    return (
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                <img className="h-20" src={selectedImage} alt="Selected Vehicle" />
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        <i className="ri-map-pin-user-fill"></i>
                        <div>
                            <h3 className='text-lg font-medium'>Pick Up From:</h3>
                    ...
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>Drop Off To:</h3>
